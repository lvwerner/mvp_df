...
.form-step-item.active  { opacity: 1; }
.form-step-item.done    { opacity: 0.7; }
.step-dot {
...
.form-step-item.active  .step-dot { background: var(--gold); color: var(--dark); }
.form-step-item.done    .step-dot { background: var(--gold); color: var(--dark); }
.step-label {
  font-size: 0.65rem; letter-spacing: 0.15em;
  text-transform: uppercase; color: var(--muted);
}
.form-step-item.active .step-label { color: var(--white); }
.form-step-divider {
...
.form-btn-row .btn-submit { flex: 1; }
.btn-back {
...
.form-info-box svg { color: var(--gold); }
...
.form-conflict-icon {
  font-size: 2rem; color: #c0392b; margin-bottom: 16px;
}
.form-conflict h3 {
  font-family: var(--font-display); font-size: 1.8rem;
  font-weight: 300; margin-bottom: 10px; color: var(--white);
}
.form-conflict p {
...
.form-success h3 {
  font-family: var(--font-display); font-size: 1.8rem;
  font-weight: 300; margin-bottom: 10px; color: var(--gold);
}
.form-success p { font-size: 0.85rem; color: var(--muted); line-height: 1.7; }
.form-success-detail {
  margin-top: 20px; padding: 16px;
  border: 1px solid var(--border);
  font-size: 0.8rem; color: var(--muted); line-height: 2;
  text-align: left;
}
.form-success-detail strong { color: var(--white); }
...
.form-error-icon {
  font-size: 1.6rem; color: #c0392b; margin-bottom: 16px;
}
.form-error h3 {
  font-family: var(--font-display); font-size: 1.8rem;
  font-weight: 300; margin-bottom: 10px; color: var(--white);
}
.form-error p { font-size: 0.85rem; color: var(--muted); line-height: 1.7; margin-bottom: 24px; }
.form-error-actions { display: flex; gap: 12px; justify-content: center; flex-wrap: wrap; }
